...
export default function Dashboard({ view, go, jumpToMap }) {
  ...
  const Page = { overview: Overview, readytowork: ReadyToWork, simulator: Simulator, solutions: PolicySolutions, geography: Geography, admissions: Admissions, send: SendDisadvantage, qualifications: Qualifications, international: International, wwc: WhiteWorkingClass, milburn: MilburnLens }[view] || Overview;
