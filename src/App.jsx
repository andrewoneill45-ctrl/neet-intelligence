...
const App = () => {
  ...
  const handleGoHome = useCallback(() => { setShowLanding(false); setSearchQuery(''); setActiveFilters(null); setSelectedSchool(null); setCompareList([]); setShowCompare(false); setShowStats(false); setHoveredSchool(null); setHoverPos(null); mapRef.current?.flyTo({ center: [-1.5, 52.8], zoom: 6, duration: 800 }); }, []);
          ...
          <div className="map-legend">
            {colorByNeet ? (
              <>
                ...
                <div className="legend-item"><div className="legend-dot" style={{ background: neetDotColor(6) }} />Mid</div>
                <div className="legend-item"><div className="legend-dot" style={{ background: neetDotColor(12) }} />High</div>
